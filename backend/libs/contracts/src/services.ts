/**
 * The ten deployable applications (V3 §3), their local ports, and the database each owns (V3 §7).
 *
 * `api-gateway` owns no database: it holds no persistent state of its own.
 */

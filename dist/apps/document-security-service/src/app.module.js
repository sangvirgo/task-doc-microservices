...
const security_pipeline_service_1 = require("./security/security-pipeline.service");
const document_security_prisma_service_1 = require("./prisma/document-security-prisma.service");
exports.SERVICE = 'document-security-service';
exports.envSchema = config_1.baseEnvSchema.extend({
    DOCUMENT_SECURITY_DATABASE_URL: zod_1.z.string().url(),
});
...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [document_security_prisma_service_1.DocumentSecurityPrismaService, security_pipeline_service_1.SecurityPipelineService],
    })
], AppModule);

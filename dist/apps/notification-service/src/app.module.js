...
exports.SERVICE = 'notification-service';
exports.envSchema = config_1.baseEnvSchema.extend({
    NOTIFICATION_DATABASE_URL: zod_1.z.string().url(),
});
...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [notification_prisma_service_1.NotificationPrismaService, notifications_service_1.NotificationsService],
    })
], AppModule);

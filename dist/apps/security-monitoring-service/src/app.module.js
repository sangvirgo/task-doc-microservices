...
exports.SERVICE = 'security-monitoring-service';
exports.envSchema = config_1.baseEnvSchema.extend({
    SECURITY_MONITORING_DATABASE_URL: zod_1.z.string().url(),
});
...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [security_monitoring_prisma_service_1.SecurityMonitoringPrismaService, monitoring_service_1.MonitoringService],
    })
], AppModule);

...
export function RetentionPanel() {
  ...
  return <section><h1>Retention & disposal</h1><p className={styles.notice}>EMPLOYEE workspace only. Eligibility, approval and disposal are decided by the service; approval and execution require its DISPOSAL_APPROVE capability check.</p>
    <div className={styles.grid}><form className={styles.form} onSubmit={placeHold}><h2>Place retention hold</h2><label>Document ID<input name="document_id" required /></label><label>Reason<input name="reason" required /></label><button>Place hold</button></form>
    <form className={styles.form} onSubmit={approve}><h2>Approve disposal</h2><label>Document ID<input name="document_id" required /></label><label>Reason<input name="reason" required /></label><button>Approve disposal</button></form>

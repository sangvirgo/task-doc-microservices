...
export function TaskList() {
  ...
  return <section className={styles.page}>
    <div className={styles.pageHeader}>
      ...
      <div className={styles.headerActions}><button className={styles.ghostButton} type="button" aria-label="More task actions">•••</button><button className={styles.primaryButton} type="button" onClick={openComposer}><span>＋</span> New task <span className={styles.buttonChevron}>⌄</span></button></div>
    </div>

...
export interface PreviewSession { id: string; document_id: string; version: number; page_count: number; total_pages: number; mime_type: string; expires_at: string; title: string; capabilities: { preview: boolean; download: boolean }; }

...
export interface Task { id: string; title: string; description: string | null; status: TaskStatus; creator_id: string; assignee_id: string | null; parent_task_id: string | null; deadline: string | null; blocked: boolean; blocked_reason: string | null; result: string | null; is_overdue: boolean; created_at: string; updated_at: string; }
